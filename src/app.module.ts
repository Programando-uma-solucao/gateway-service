...
import { AccountServiceConfig, CipherServiceConfig } from './config/microservices.config';

@Module({
  imports: [ClientsModule.register([AccountServiceConfig, CipherServiceConfig])],
  controllers: [
    AccountController,
    LawyerController,
    QuestionController,
